...
pub enum OracleSetup {
    ...
    ReservedDlmmTwap,
    ReservedKeeperFed,
    /// Hybrid DLMM TWAP + Keeper oracle with TVL-weighted pricing.
    /// Falls back to DLMM TWAP alone when keeper is stale.
    HybridDlmmKeeper,
}
...
impl OracleSetup {
    pub fn from_u8(value: u8) -> Option<Self> {
        match value {
            ...
            13 => Some(Self::ReservedDlmmTwap),
            14 => Some(Self::ReservedKeeperFed),
            15 => Some(Self::HybridDlmmKeeper),
            _ => None,
        }
    }
}
