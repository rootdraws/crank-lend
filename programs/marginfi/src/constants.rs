...
/// Sanctum SPL Stake Pool program (fork of standard SPL Stake Pool with identical layout).
pub const SANCTUM_STAKE_POOL_PROGRAM_ID: Pubkey =
    pubkey!("SP12tWFxD9oJsVWNavTTBZvMbA6gkAmxtVgxdqvyvhY");

/// Minimum TWAP lookback period (seconds) to resist oracle manipulation.
/// Trades within this window alone cannot determine the reported price.
pub const DLMM_TWAP_MIN_WINDOW_SECS: i64 = 300;
